...
export default class ChangeTimeGroupMeetingEmail extends Template {
  getOptions() {
    return {
      subject: 'Изменено время встречи!',
    };
  }
  render({ ctx, params = {} }) {
    const data = {
    ...
    if (params.event) {
      ...
      if (params.event.place) {
        ...
        if (params.event.place && params.event.place.address) {
  ...
  <body>
    ...
    <div class="mail">
      ...
      <div class="body_mail">
        ...
        <div class="content">
          <h1>Время групповой встречи "${data.event.title}" изменено.</h1>
          <div class="jays">
            <div class="jay">
              <div class="avatar">
                <div class="position">
              ...
              <div class="meeting i">
                  ...
                  <div class="place">${data.event.place} </div>
