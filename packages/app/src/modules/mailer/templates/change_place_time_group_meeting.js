...
export default class ChangePlaceTimeGroupMeetingEmail extends Template {
  getOptions() {
    return {subject: 'Изменено место и время встречи!'};
  }
  render({
    ctx,
    params = {}
    ...
    if (params.event) {
      ...
      // .locale(params._profile.nativeLanguage || 'en')
        .locale('ru' || 'en').format('LL [в] LT').replace('г. ', '');
  ...
  <body>
    ...
    <div class="mail">
      ...
      <div class="body_mail">
        ...
        <div class="content">
          <h1>Время и место групповой встречи "${data.event.title}" изменено.</h1>
          <div class="jays">
            <div class="jay">
              <div class="avatar">
                <div class="position">
              ...
              <div class="meeting i">
                  ...
                  <div class="time">${data.event.date}<font style="color:#dd0000">(обновлено)</style></div>
              </div>
              <div class="clear"></div>
            </div>
